...
| **Design System** | `DESIGN.md` เป็น source of truth สำหรับ UI agents: Thai-first Sarabun, operational console, primary orange, compact mobile station flows, no default-purple drift, และ Tank Loy ไม่มี engine-oil/product flow | [→ design-system.md](topics/design-system.md) |
