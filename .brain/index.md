...
| **Station Types** | 6 สถานี: แท๊งลอยใช้ staff UI เดียว `/station/1/v2`, classic admin `/station/1`, legacy `/station/1/new/*` redirect เข้า V2 ยกเว้น receipt, V2 meter start ต้อง sync `Shift OPEN`, มี daily print report กระทบยอดมิเตอร์ทั้ง A4/thermal 58/80mm, และตัด stale staff session ก่อน 2026-04-27 18:36 +07; SIMPLE ใช้ `/simple-station`; GAS ใช้ staff `/gas/[id]`, กะ 1 = 07:00-19:00 และกะ 2 = 19:00-07:00 ข้ามวันได้, supply receiving `/gas/[id]/supplies`, meter continuity/admin meter report ใช้ยอดรับจริงจาก reconciliation, admin แก้เลขเปิดมิเตอร์และยอดสรุปกะจาก meter report ได้พร้อม Audit Log, executive print report `/admin/gas/reports/executive`, และ admin `/admin/gas/*` โดย `/admin/gas-control` redirect ไป v2 | [→ station-types.md](topics/station-types.md) |
