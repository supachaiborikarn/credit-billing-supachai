...
| Topic | สรุป | ไฟล์ |
|-------|------|------|
| **Billing System** | ระบบออกบิลน้ำมัน/แก๊ส, book/number sorting แบบ numeric, 7 ประเภทการชำระ, และการรวมบิลยึด `ownerId` เป็นหลัก | [→ billing-system.md](topics/billing-system.md) |
...
| **Bugs & Fixes** | bugs/gotchas สำคัญ รวมถึง API auth gap, audit atomicity, variance sign convention, fix แท๊งลอยให้ใช้ shift scope ถูกต้อง, sync หน้าใหม่ของแท๊งลอย, และ GAS hardening 2026-04-23: v2 gauge/auth/shift/payment/product guard + stale-shift cleanup tool | [→ bugs-and-fixes.md](topics/bugs-and-fixes.md) |
