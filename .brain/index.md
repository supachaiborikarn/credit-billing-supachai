...
| **Bugs & Fixes** | bugs/gotchas สำคัญ รวมถึง API auth gap, audit atomicity, variance sign convention, fix แท๊งลอยให้ใช้ shift scope ถูกต้อง, sync หน้าใหม่ของแท๊งลอย, GAS hardening/analytics 2026-04-23, fix live incident 2026-04-24 ที่ legacy GAS new home/metrics สร้างกะหรือ daily record ว่างผิด flow, และ staff daily GAS price edit 2026-04-25 | [→ bugs-and-fixes.md](topics/bugs-and-fixes.md) |
