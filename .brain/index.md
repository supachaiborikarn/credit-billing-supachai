...
| **Station Types** | 6 สถานี: FULL station-1 sale/open/close/shift-end/redirect-only meters ย้าย canonical แล้วถึง S60; `/station/1` + V2 ยังเก็บ admin compatibility. SIMPLE station-2/3/4 retired operational ครบ S45-S52 โดยคง read/history/receipt/API. GAS station-5/6 sell + open/close ย้าย canonical ถึง S63; S64-S68 ล็อกให้ meter/gauge correction, supplies, station-5 products และ GAS landing ยัง KEEP ตาม capability จริง; S69 เพิ่มทางเข้า secondary GAS tools และ S70 ย้าย audited staff price update เข้า canonical Overview; S71 ยืนยัน GAS landing ยังขาด payment buckets + latest tank percentages + low-tank alerts; S72 ย้าย compact live summary เหล่านี้เข้า canonical Overview และ S73 retire root `/gas/5|6` ไป canonical Overview แล้ว โดยยัง KEEP meter/gauge correction, supplies, station-5 products และ summary compatibility routes. GAS กะ 07:00-19:00 / 19:00-07:00 | [→ station-types.md](topics/station-types.md) |
