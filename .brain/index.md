...
| **Station Types** | 6 สถานี: แท๊งลอยใช้ staff UI เดียว `/station/1/v2`, classic admin `/station/1`, legacy `/station/1/new/*` redirect เข้า V2 ยกเว้น receipt, V2 meter start ต้อง sync `Shift OPEN`, มี daily print report กระทบยอดมิเตอร์ทั้ง A4/thermal 58/80mm, และตัด stale staff session ก่อน 2026-04-27 18:36 +07; SIMPLE ใช้ `/simple-station`, GAS ใช้ staff `/gas/[id]` พร้อม open-shift guard/เลือกกะเมื่อยังไม่มี record วันนี้ และ admin `/admin/gas/*` | [→ station-types.md](topics/station-types.md) |
| **Bugs & Fixes** | bugs/gotchas สำคัญ รวมถึง API auth gap, audit atomicity, variance sign convention, fix แท๊งลอยให้ใช้ shift scope ถูกต้อง, sync หน้าใหม่ของแท๊งลอย, harmonize UI/ตัด flow น้ำมันเครื่อง, bottom nav/daily report, V2 daily print reconciliation + thermal 58/80mm 2026-04-28, per-transaction thermal print/reprint 58/80mm, canonical staff route `/station/1/v2`, Tank Loy stale staff session force logout, Tank Loy V2 meter-start/no-shift auto-repair 2026-04-28, V2 command panel + admin data health 2026-04-27, V2 print/photo review และ required evidence guard 2026-04-27, GAS hardening/analytics 2026-04-23, fix live incident 2026-04-24, staff daily GAS price edit 2026-04-25, GAS credit bill/reconciliation validation 2026-04-25, GAS stale open shift guard, GAS orphan transaction report guard, GAS amount-based sale entry/meter report clarity 2026-04-25, GAS close-shift other sales/expenses 2026-04-27, GAS persistent price/admin operations 2026-04-28, GAS admin data-entry สร้าง/แก้กะตรงจากแอดมิน 2026-04-28, GAS staff open-shift silent-submit guard 2026-04-28, และ GAS afternoon meter unique fix 2026-04-29 | [→ bugs-and-fixes.md](topics/bugs-and-fixes.md) |
