...
| **Station Types** | 6 สถานี: FULL station-1 sale/open/close/shift-end/redirect-only meters ย้าย canonical แล้วถึง S60; `/station/1` + V2 ยังเก็บ admin compatibility. SIMPLE station-2/3/4 retired operational ครบ S45-S52 โดยคง read/history/receipt/API. GAS station-5/6 sell + open/close ย้าย canonical ถึง S63; S64-S68 ล็อกให้ meter/gauge correction, supplies, station-5 products และ GAS landing ยัง KEEP ตาม capability จริง; S69-S72 ปิด tool/price/live-summary parity, S73 retire root `/gas/5|6`, S74 flatten older landing/new/home, S75-S76 ยืนยัน older meters/supplies ให้ map ไป current compatibility routes, และ S77 แก้ older products ตาม capability: station-5 ไป product inventory, station-6 ไป canonical Overview. S78 KEEP older/current summary และ flatten เฉพาะ monthly-balance UI โดยคง monthly-balance API compatibility; S79 เติม meter detail + recent transactions เข้า canonical จาก summary API เดิมจน parity ready แต่ current/older summary ยัง KEEP รอ S80 boundary retirement review. meter/gauge correction, supplies และ station-5 products ยัง KEEP. GAS กะ 07:00-19:00 / 19:00-07:00 | [→ station-types.md](topics/station-types.md) |
