...
| **Station Types** | 6 สถานี: แท๊งลอยใช้ staff UI เดียว `/station/1/v2`, classic admin `/station/1`, legacy `/station/1/new/*` redirect เข้า V2 ยกเว้น receipt, และตัด stale staff session ก่อน 2026-04-27 18:36 +07; SIMPLE ใช้ `/simple-station`, GAS ใช้ `/gas` | [→ station-types.md](topics/station-types.md) |
