...
| **Station Types** | 6 สถานี: FULL station-1 ยังคง operational `/station/1/v2`; S55-S56 retire sale entries ไป canonical sales และ S57 retire `/station/1/new/open-shift` ไป canonical operations หลัง operational/financial gates; SIMPLE station-2/3/4 retired operational ครบ S45-S52 โดยคง read/history/receipt/API; GAS station-5/6 S53-S54 retire current+older sell ไป canonical sales ขณะที่ non-sell operational/read routes ยัง compatibility; GAS กะ 07:00-19:00 / 19:00-07:00, supply receiving, meter continuity, reconciliation/admin reports ยังอยู่ | [→ station-types.md](topics/station-types.md) |
