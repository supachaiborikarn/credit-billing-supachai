...
| 5 | ปั๊มแก๊สพงษ์อนันต์ | GAS | canonical `/stations/station-5` | แก๊ส + สินค้า; recovery อยู่ Operations, LPG + product inventory อยู่ Inventory |
...
- **GAS canonical product inventory**: `/src/components/stations/GasProductInventory.tsx`; S100 รองรับ create/receive/price-alert/history ของ station-5 และ legacy product page อยู่ `LegacyGasProductsPage.tsx`
...
## Changelog
- 2026-08-29: S101 ย้าย retired SIMPLE station-2/3/4 summary maintenance เข้า canonical History; STAFF read/view-slip/print/CSV only, ADMIN edit/void/proof/Audit และยังคง receipt compatibility แยก
- 2026-08-29: S100 ย้าย station-5 product inventory เข้า canonical Inventory, retire current/older product bookmarks และแก้ product GET ให้ read-only โดยถอด Station.upsert
