...
export default function FullAdminLayout({
    children,
}: {
    ...
    const navItems = [
        { href: '/admin/full', icon: LayoutDashboard, label: 'Dashboard', exact: true },
        { href: '/admin/full/anomalies', icon: AlertTriangle, label: 'ความผิดปกติ' },
    ];
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-amber-700 to-orange-700 shadow-lg">
                <div className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="font-bold text-lg">🛢️ แท๊งลอยวัชรเกียรติ</h1>
                            <p className="text-sm text-white/70">ศูนย์ควบคุมปั๊มน้ำมันหลัก</p>
                        </div>
                    </div>
