    ...
    try {
        ...
        const formattedShifts = shifts.map((shift) => ({
            ...
            reconciliation: shift.reconciliation?.hasRecord ? {
                ...
                productSalesAmount: shift.reconciliation.productSalesAmount,
                productTransferAmount: shift.reconciliation.productTransferAmount,
                otherIncomeAmount: shift.reconciliation.otherIncomeAmount,
