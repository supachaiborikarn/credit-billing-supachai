...
| --- | --- | --- | --- |
| `/station/1/v2` | canonical Overview / Operations / History | **KEEP_FULL_ADMIN_MAINTENANCE_COMPAT — S94 PARTIAL MIGRATION** | S93 moved daily retail/wholesale correction into canonical Operations. S94 moved historical start/end meter + photo correction into canonical Operations, made historical meter/photo writes ADMIN-only, required existing DailyRecord/Shift binding, and removed V2 meter mutation. V2 now remains only for transaction/slip/receipt maintenance plus audit/CSV/daily-print tooling pending S95/S96. |
