...
| `/station/1/new/close-shift` | `/stations/station-1/operations` | KEEP_UNTIL_S38_S40 | S39 not complete. |
| `/station/1/new/shift-end` | `/stations/station-1/operations` | KEEP_UNTIL_S38_S40 | Closing/reconciliation compatibility. |
...
| `/gas/[id]/shift/open` | `/stations/station-[id]/operations` | KEEP_UNTIL_S38_S40 | S38 canonical opening complete; keep legacy until S39/S40 + final regression. |
...
**S44 status (2026-08-27): PASS.** See `FINANCIAL_REGRESSION_CHECKLIST.md`. S57 reran the full financial gate after FULL `/station/1/new/open-shift` direct-canonical retirement changes: 16 files / 81 tests passed; opening/closing/history operational regression also passed. Remaining active operational/money routes are still eligible only for bounded one-family review.
...
4. Active FULL opening entry → canonical operations — **S57 `/station/1/new/open-shift` complete** after S38-S40 parity/regression; close/shift-end remain separate bounded reviews.
