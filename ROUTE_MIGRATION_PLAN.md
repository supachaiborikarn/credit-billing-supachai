...
| `/station/1/new/summary` | `/station/1/v2` / future canonical maintenance | **KEEP_FULL_ADMIN_COMPAT — S88 REVIEWED** | Not read-only: owns transaction edit/void, transfer-slip replacement, receipt/credit reprint, CSV export and daily report print. V2 covers edit/void, viewing slips, 58/80 receipt/credit print and daily report, but still lacks CSV export and historical transfer-slip replacement. Do not retire until those two capabilities move. |
