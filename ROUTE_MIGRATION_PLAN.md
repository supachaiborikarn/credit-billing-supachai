...
| Legacy route | Future route | Disposition | Notes |
| --- | --- | --- | --- |
| `/gas/5`, `/gas/6` | `/stations/station-5`, `/stations/station-6` | **KEEP_GAS_WORKSPACE (S68 REVIEWED; S69 TOOLS; S70 PRICE MIGRATED)** | Canonical Overview now exposes retained correction/inventory tools and audited staff gas-price update. Keep landing until S71 reviews remaining read/dashboard parity: live sales summary, gauge status and alerts. |
