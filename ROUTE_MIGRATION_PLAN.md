...
| --- | --- | --- | --- |
| `/station/1` | `/station/1/v2` | **S91 IMPLEMENTED** | Classic FULL root is retired to V2. S91 parity covered the former classic capabilities; S93 subsequently moved daily-price maintenance onward from V2 into canonical Operations. New owner plates auto-create Truck records in the transaction API; standalone truck CRUD remains available at `/trucks`. |
