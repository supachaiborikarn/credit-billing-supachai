...
| --- | --- | --- | --- |
| `/station/1/v2` | canonical Overview / Operations / History | **READY_FOR_S96_RETIREMENT_UAT — S95 COMPLETE** | S93/S94 moved daily-price and meter/photo correction to canonical Operations. S95 moved transaction edit/void, transfer-proof maintenance, receipt/credit 58/80 reprint, filtered CSV, daily print and real AuditLog review to canonical History; historical create is ADMIN-only and requires an existing OPEN Shift. V2 no longer owns a unique business capability, but remains reachable until S96 isolated UAT and redirect gates pass. |
